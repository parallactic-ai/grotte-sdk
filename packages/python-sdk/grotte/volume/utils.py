...
from grotte.volume.client.models import VolumeEntryStat as VolumeEntryStatApi
from grotte.volume.client.types import UNSET
from grotte.volume.types import VolumeEntryStat
