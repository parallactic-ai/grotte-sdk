...
from grotte.exceptions import BuildException
from grotte.template.consts import STACK_TRACE_DEPTH, RESOLVE_SYMLINKS
from grotte.template.dockerfile_parser import parse_dockerfile
from grotte.template.readycmd import ReadyCmd, wait_for_file
...
from grotte.template.utils import (
...
class TemplateBuilder:
    """
    Builder class for adding instructions to an GROTTE template.
    ...
    def set_start_cmd(
        ...
        from grotte import wait_for_port, wait_for_url
    ...
    def set_ready_cmd(self, ready_cmd: Union[str, ReadyCmd]) -> "TemplateFinal":
        ...
        # Using ReadyCmd helpers
        from grotte import wait_for_port, wait_for_file, wait_for_process
...
class TemplateBase:
    ...
    def __init__(
        ...
        """
        self._default_base_image: str = "parallactic/base"
    ...
    def from_base_image(self) -> TemplateBuilder:
        """
        Start template from the GROTTE base image (parallactic/base:latest).
    ...
    def from_template(self, template: str) -> TemplateBuilder:
        """
        Start template from an existing GROTTE template.
    ...
    def to_dockerfile(template: "TemplateClass") -> str:
        ...
        :raises ValueError: If the template is based on another GROTTE template or has no base image
