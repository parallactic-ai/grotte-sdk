...
def wait_for_port(port: int):
    ...
    Example
    ```python
    from grotte import Template, wait_for_port
...
def wait_for_url(url: str, status_code: int = 200):
    ...
    Example
    ```python
    from grotte import Template, wait_for_url
...
def wait_for_process(process_name: str):
    ...
    Example
    ```python
    from grotte import Template, wait_for_process
...
def wait_for_file(filename: str):
    ...
    Example
    ```python
    from grotte import Template, wait_for_file
...
def wait_for_timeout(timeout: int):
    ...
    Example
    ```python
    from grotte import Template, wait_for_timeout
