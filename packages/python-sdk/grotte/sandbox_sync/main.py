...
from grotte.api.client_sync import get_transport
from grotte.connection_config import ApiParams, ConnectionConfig
from grotte.envd.api import ENVD_API_HEALTH_ROUTE, handle_envd_api_exception
from grotte.envd.versions import ENVD_DEBUG_FALLBACK
from grotte.exceptions import (
    SandboxException,
    format_request_timeout_error,
)
from grotte.sandbox.main import SandboxOpts
...
from grotte.sandbox.utils import class_method_variant
from grotte.sandbox_sync.commands.command import Commands
from grotte.sandbox_sync.commands.pty import Pty
from grotte.sandbox_sync.filesystem.filesystem import Filesystem
from grotte.sandbox_sync.git import Git
from grotte.sandbox_sync.sandbox_api import SandboxApi, SandboxInfo
from grotte.sandbox_sync.paginator import SnapshotPaginator
from grotte.api.client.models import SandboxVolumeMount as SandboxVolumeMountAPI
from grotte.volume.volume_sync import Volume
...
class Sandbox(SandboxApi):
    ...
    def resume(
        ...
        **opts: Unpack[ApiParams],
        ...
        Example::
            ...
            sbx.resume()
        """
        return self.connect(timeout=timeout, **opts)
    ...
    def _create(
        ...
        **opts: Unpack[ApiParams],
        ...
        extra_sandbox_headers["Grotte-Sandbox-Id"] = sandbox_id
        extra_sandbox_headers["Grotte-Sandbox-Port"] = str(ConnectionConfig.envd_port)
